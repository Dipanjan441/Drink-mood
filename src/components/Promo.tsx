                ...
                <div className="grid md:grid-cols-2 gap-10 items-center">
                    <div className="space-y-6">
                        ...
                        <div className="flex flex-wrap gap-4 pt-4">
                            <a href="#contact" className="px-8 py-3 bg-yellow text-black rounded-full font-bold hover:bg-white hover:scale-105 transition-all duration-300">
                                Hire Me
                            </a>
                            <a href="#" className="px-8 py-3 border border-white/20 rounded-full font-medium hover:bg-white/10 transition-all duration-300">
                                View Portfolio
                            </a>
                        </div>
                    </div>

                    <div className="relative h-full min-h-[300px] flex-center border border-white/10 rounded-2xl bg-black/20 p-8">
                        ...
                        <div className="text-center space-y-4">
                            ...
                            <ul className="space-y-3 text-white/60 text-sm text-left inline-block">
                                <li className="flex items-center gap-3">
                                    <span className="w-2 h-2 rounded-full bg-yellow" /> Custom Web Development
                                </li>
                                <li className="flex items-center gap-3">
                                    <span className="w-2 h-2 rounded-full bg-yellow" /> GSAP & 3D Animations
                                </li>
                                <li className="flex items-center gap-3">
                                    <span className="w-2 h-2 rounded-full bg-yellow" /> Interactive UI/UX Design
                                </li>
                                <li className="flex items-center gap-3">
                                    <span className="w-2 h-2 rounded-full bg-yellow" /> Performance Optimization
                                </li>
                            </ul>
                        </div>
                    </div>
